 // Slightly modified version of https://github.com/NYTimes/svg-crowbar
 // Credit New York times dev team
  ...
  function initialize () {
    ...
    documents.forEach(function(doc) {
      ...
      for (var i = 0; i < newSources.length; i++) {
        ...
        if(newSources[i].class === "visualization-layer")
